...
export default function UploadForm({ paths, fileUploaded, setIsModalOpen, setFileUploaded, setPaths}: {paths:string[], fileUploaded:string[], setIsModalOpen: React.Dispatch<React.SetStateAction<boolean>>, setFileUploaded: React.Dispatch<React.SetStateAction<Array<string>[]>>, setPaths:React.Dispatch<React.SetStateAction<Array<string>[]>>}) {
