...
export default function UploadForm({ paths, fileUploaded, setIsModalOpen, setFileUploaded, setPaths}: {paths:string[], fileUploaded:string[], setIsModalOpen: React.Dispatch<SetStateAction<boolean>>, setFileUploaded: React.Dispatch<SetStateAction<Array<string>[]>>, setPaths:React.Dispatch<SetStateAction<Array<string>[]>>}) {
